...
import pygtk, sys, ConfigParser, commands, logging
pygtk.require('2.0')
import gtk
...
class HDMIController:
    def saveAndApply(self, widget, data=None):
        #self.applySettings()
        self.saveConfig()
        print "Saved and applied settings."
    ...
    def applySettings(self):
        ...
        self.displayConfig(self, self.hdmi_name, mode = mode_name, pos = "0x0", primary = self.primary_check.get_active())
    ...
    def __init__(self):
        ...
        self.window.set_title("HDMI-Out Controller")
